...
const bgSound = new Audio("./sound/dynamite.mp3");
const bugSound = new Audio("./sound/bug_pull.mp3");
const winSound = new Audio("./sound/gane_win.mp3");
...
function showStopButton() {
  const icon = gameBtn.querySelector(".fa-gamepad");
  icon.classList.add("fa-stop");
  icon.classList.remove("fa-gamed");
